...
#else
    std::inclusive_scan(default_policy, first, last, output);
#endif
  }
...
#else
    std::inclusive_scan(default_policy, first, last, output, op);
#endif
  }
...
#else
    std::inclusive_scan(default_policy, first, last, output, op, init);
#endif
  }
...
#else
    std::exclusive_scan(default_policy, first, last, output, init);
#endif
  }
...
#else
    std::exclusive_scan(default_policy, first, last, output, init, op);
#endif
  }
