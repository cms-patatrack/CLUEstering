  ...
  PYBIND11_MODULE(CLUE_CPU_OMP, m) {
    ...
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  ...
                                  int32_t,
                                  size_t,
                                  size_t>(&alpaka_omp2_async::mainRun<clue::FlatKernel>),
          "mainRun");
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  float,
                                  ...
                                  int32_t,
                                  size_t,
                                  size_t>(&alpaka_omp2_async::mainRun<clue::ExponentialKernel>),
          "mainRun");
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  float,
                                  ...
                                  int32_t,
                                  size_t,
                                  size_t>(&alpaka_omp2_async::mainRun<clue::GaussianKernel>),
          "mainRun");
  }
};  // namespace alpaka_omp2_async
