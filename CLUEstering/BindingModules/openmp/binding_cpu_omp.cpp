  ...
  PYBIND11_MODULE(CLUE_CPU_OMP, m) {
    ...
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  ...
                                  size_t,
                                  size_t>(
              &alpaka_omp2_async::mainRun<float, clue::FlatKernel<float>>),
          "mainRun");
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  float,
                                  ...
                                  size_t,
                                  size_t>(
              &alpaka_omp2_async::mainRun<float, clue::ExponentialKernel<float>>),
          "mainRun");
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  float,
                                  ...
                                  size_t,
                                  size_t>(
              &alpaka_omp2_async::mainRun<float, clue::GaussianKernel<float>>),
          "mainRun");
    // m.def("mainRun",
