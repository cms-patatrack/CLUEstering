  ...
  PYBIND11_MODULE(CLUE_GPU_CUDA, m) {
    ...
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  ...
                                  int32_t,
                                  size_t,
                                  size_t>(&alpaka_cuda_async::mainRun<clue::FlatKernel>),
          "mainRun");
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  float,
                                  ...
                                  int32_t,
                                  size_t,
                                  size_t>(&alpaka_cuda_async::mainRun<clue::ExponentialKernel>),
          "mainRun");
    m.def("mainRun",
          pybind11::overload_cast<float,
                                  float,
                                  ...
                                  int32_t,
                                  size_t,
                                  size_t>(&alpaka_cuda_async::mainRun<clue::GaussianKernel>),
          "mainRun");
  }
};  // namespace alpaka_cuda_async
