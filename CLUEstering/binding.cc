...
mainRun(float dc, float rhoc, float outlier, int pPBin, kernel const& ker,
  ...
  switch (Ndim) {
  [[unlikely]] case (1) :
    return run1(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[likely]] case (2) :
    return run2(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[likely]] case (3) :
    return run3(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[unlikely]] case (4) :
    return run4(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[unlikely]] case (5) :
    return run5(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[unlikely]] case (6) :
    return run6(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[unlikely]] case (7) :
    return run7(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[unlikely]] case (8) :
    return run8(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[unlikely]] case (9) :
    return run9(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[unlikely]] case (10) :
    return run10(dc, rhoc, outlier, pPBin, ker, coords, weight);
    break;
  [[unlikely]] default:
