We are constantly trying to extend the library, improve the user experience and the documentation. Any contribution or feedback is highly appreciated.
...
3. Add your changes and commit them with a clear and concise message. Also make sure that the source files, as well as the CMake files, are formatted using
respectively `clang-format` and `cmake-format`.
